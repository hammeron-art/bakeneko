...
class TestStress extends BakenekoTestCase
{
    public function testDotProduct()
    {
        ...
        for (i in 0...iters)
        {
            var a = new Vector2Base(i * 1.2, i * 4.3);
            var b = new Vector2Base(i * 1.1, i * 0.8);
    ...
    public function testMatrixProduct()
    {
        ...
        for (i in 0...iters)
        {
            var a:Matrix3x3 = new Matrix3x3Base(
                i * 1.2, i * 4.3, i * 1.2,
                i * 4.3, i * 1.2, i * 4.3,
                i * 1.2, i * 4.3, i * 1.2);
            var b:Matrix3x3 = new Matrix3x3Base(
                i * 1.1, i * 0.8, i * 1.1,
                i * 0.8, i * 1.1, i * 0.8,
                i * 1.1, i * 0.8, i * 1.1);
            var c:Matrix3x3 = a * b;
        ...
        for (i in 0...iters)
        {
            var a = new Matrix3x3Base(
                i * 1.2, i * 4.3, i * 1.2,
                i * 4.3, i * 1.2, i * 4.3,
                i * 1.2, i * 4.3, i * 1.2);
            var b = new Matrix3x3Base(
                i * 1.1, i * 0.8, i * 1.1,
                i * 0.8, i * 1.1, i * 0.8,
                i * 1.1, i * 0.8, i * 1.1);
            var c = new Matrix3x3Base(
