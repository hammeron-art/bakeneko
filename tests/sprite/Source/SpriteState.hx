...
class SpriteState extends State {
	...
	override public function onInit():Void {
		...
		vertexFormat.push(new VertexElement(TFloat(3), SPosition));
		vertexFormat.push(new VertexElement(TFloat(4), SColor));
		vertexFormat.push(new VertexElement(TFloat(2), STexcoord));
		
		var material1:Material = new Material("custom1", vertexFormat);
		var material2:Material = new Material("custom2", vertexFormat);
		...
		/*app.input.bindKey('left', Key.left);
		app.input.bindKey('right', Key.right);
		app.input.bindKey('up', Key.up);
		app.input.bindKey('down', Key.down);
		app.input.bindKey('a', Key.key_a);
		app.input.bindKey('z', Key.key_z);
		app.input.bindKey('c', Key.key_c);*/
	}
