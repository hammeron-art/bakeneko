...
/**
 * The underlying type of Vector4
 */
class Vector4Base {
    public var x:Float;
    public var y:Float;
 ...
 */
@:forward(x, y, z, w)
abstract Vector4(Vector4Base) from Vector4Base to Vector4Base {
     ...
     */
    public static inline function FromArray(array:Array<Float>):Vector4 {
        if (array.length != Vector4.elementCount)
        {
    ...
    @:op(A * B)
    @:commutative
    public static inline function MultiplyScalar(a:Vector4, s:Float):Vector4 {
     ...
     */
    @:op(A / B)
    public static inline function DivideScalar(a:Vector4, s:Float):Vector4 {
	 ...
	 */
    @:op(A * B)
	public static inline function Multiply(a:Vector4, b:Vector4):Vector4 {
	 ...
	 */
    @:op(A / B)
	public static inline function Divide(a:Vector4, b:Vector4):Vector4 {
     ...
     * @return      self_i *= s
     */
    public inline function multiplyScalar(s:Float):Vector4 {
     ...
     * @return      self_i /= s
     */
    public inline function divideScalar(s:Float):Vector4 {
        var self:Vector4 = this;
     ...
     * @return      self_i -= a_i
     */
    public inline function multiply(a:Vector4):Vector4 {
        var self:Vector4 = this;
     ...
     * @return      self_i -= a_i
     */
    public inline function divide(a:Vector4):Vector4 {
        var self:Vector4 = this;
     ...
     */
    public inline function max(a:Vector4):Vector4 {
        var self:Vector4 = this;
     ...
     */
    public inline function min(a:Vector4):Vector4 {
        var self:Vector4 = this;
    ...
    public inline function projectOnto(a:Vector4):Vector4 {
        ...
        var s:Float = Vector4.Dot(self, a) / Vector4.Dot(a, a);
...
/**
    ...
    public inline function setArrayElement(i:Int, value:Float):Float {
		// TODO: optimize when underlying type changes to array
        var self:Vector4 = this;
        switch (i)
        {
            case 0:
