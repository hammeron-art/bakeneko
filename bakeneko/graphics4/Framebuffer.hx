...
class Framebuffer {
	...
	private var graphics4: bakeneko.graphics4.Graphics;

	/**
	 * Used internally.
	 */
	public function new(windowId: Int, /*g1: kha.graphics1.Graphics, g2: kha.graphics2.Graphics,*/ g4: bakeneko.graphics4.Graphics) {
	 ...
	 * Used internally.
	 */
	public function init(/*g1: kha.graphics1.Graphics, g2: kha.graphics2.Graphics,*/ g4: bakeneko.graphics4.Graphics): Void {
		/*this.graphics1 = g1;
		this.graphics2 = g2;*/
		this.graphics4 = g4;
	}
	 ...
	 */
	public var g4(get, null): bakeneko.graphics4.Graphics;

	private function get_g4(): bakeneko.graphics4.Graphics {
		return graphics4;
	}
